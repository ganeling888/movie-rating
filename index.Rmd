...
#### combine the data, because this needs time, we can save the result for next time
...
# }
# newraitings = combine_user(users, training_ratings, 3000)
# save(newraitings, file = "newraitings.RData")
